package net.liopyu.menujs.client.screens.vanilla;
...
@OnlyIn(Dist.CLIENT)
public class ChestMenuScreenJS<T extends AbstractContainerMenu> extends ContainerScreen implements ContainerListener, IScreenContainerJS {
    private final ChestMenuBuilderJS builder;
    private final Inventory playerInventory;

    public ChestMenuScreenJS(AbstractContainerBuilder<T> builder, ChestMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle);
        this.builder = (ChestMenuBuilderJS) builder;
        this.playerInventory = pPlayerInventory;
    }

   /* public ChestMenuScreenJS(AbstractContainerBuilder<T> builder, T pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle);
        this.builder = (ChestMenuBuilderJS) builder;
        this.playerInventory = pPlayerInventory;
    }*/
